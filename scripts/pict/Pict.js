...
(
		...
		PictInteractionsEventWireup, PictRecordLists, PictEntityList)
	{
		...
		// This holds the automatically defined stricture PICT settings.
		var getStrictureModel = function() { return _StrictureModel; };
		var setStrictureModel = function(pModel) { _StrictureModel = pModel; };
		Object.defineProperty(oPict, 'strictureModel', {get:getStrictureModel, set:setStrictureModel});
