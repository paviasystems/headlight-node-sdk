...
(
	['pict/Pict',
		...
		'pict/record/controller/operation/Pict-DataOperation-Update', 'pict/record/controller/operation/Pict-DataOperation-Create', 'pict/record/controller/operation/Pict-DataOperation-Duplicate',
	...
	function(Pict,
		...
		PictDataOperationUpdate, PictDataOperationCreate, PictDataOperationDuplicate,
		PictDataOperationDelete)
	{
		function oNew(pDataSetHash, pMeadowHash)
		{
			...
			var _RecordTemplateMacros = PictUIRecordTemplateMacros.New(_Pict);
			...
			_Behaviors.Duplicate = PictDataOperationDuplicate(oDataOperation, _Pict);
			Object.defineProperty(oDataOperation, 'Duplicate', {get: function() { return _Behaviors.Duplicate; }});
