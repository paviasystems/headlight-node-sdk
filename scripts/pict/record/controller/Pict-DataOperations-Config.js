	...
	function()
	{
		function oNew(pRecordSetHash, pMeadowHash, pPict)
		{
			...
			*/
			...
			var _MetaRecordColumns = [];
			var addMetaRecordColumn = function(pOptions)
			{
				pOptions.Pict = _Pict;
				_MetaRecordColumns.push(pOptions);
			};
			var _MetaRecordDisplayAuditDetails = true;

			var _PictConfig = {};
			var setPictConfig = function(pPictConfig)
			{
				_PictConfig = pPictConfig;
			};
			...
			oConfig = (
			{
				...
				AddMetaRecordColumn: addMetaRecordColumn,
				SetPictConfig: setPictConfig,
			...
			Object.defineProperty(oConfig, 'MetaRecordColumns', {get: function() { return _MetaRecordColumns; }});
			Object.defineProperty(oConfig, 'MetaRecordDisplayAuditDetails', {get: function() { return _MetaRecordDisplayAuditDetails; }});
			Object.defineProperty(oConfig, 'PictConfig', {get: function() { return _PictConfig; }});
