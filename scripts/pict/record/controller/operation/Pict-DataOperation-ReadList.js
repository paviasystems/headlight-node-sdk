	...
	function(PictDataOperationReadListPaging)
	{
		function oNew(pDataOperations, pPict)
		{
			...
			var _Default_Options_ReadList = (
			{
				...
				// This value is prepended to the filter, only for the route sent to the server.
				ListFilterPrefix: undefined,
			...
			var ReadRecordList = function (pOptions)
			{
				...
				if (tmpOptions.ListFilterPrefix)
				{
					tmpAPIReadListURI += tmpOptions.ListFilterPrefix;
				}
				...
				(
					function (pData)
					{
						...
						_ApplicationDataPaging.DisplayPagingControl(tmpOptions, _Pict);
